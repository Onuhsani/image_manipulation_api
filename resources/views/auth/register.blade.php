...
<head>
    ...
    <title>ImageManipulationApi Sign up</title>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form" action="{{ route('user.register') }}" enctype="multipart/form-data" file="true">
                            @csrf
                    ...
                    <div class="signup-image">
                        <figure><img src="{{ asset('forms/images/signup-image.jpg') }}" alt="sing up image"></figure>
                    </div>
                </div>
            </div>
        </section>
